          ...
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <h3 className="text-lg font-medium text-gray-900 mb-4">
                {editForm.appointmentDate ? 'Chỉnh sửa Appointment' : 'Chi tiết Appointment'}
              </h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{selectedAppointment.patient?.name || 'N/A'}</p>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-gray-700">Bác sĩ</label>
                  <p className="text-sm text-gray-900">{selectedAppointment.doctor?.name || 'N/A'}</p>
                </div>
                  ...
                  <>
                    <div>
                      ...
                      <p className="text-sm text-gray-900">
                        {selectedAppointment.appointmentDate ? new Date(selectedAppointment.appointmentDate).toLocaleDateString('vi-VN') : 'N/A'}
                      </p>
                    </div>
                    
                    <div>
                      <label className="block text-sm font-medium text-gray-700">Giờ hẹn</label>
                      <p className="text-sm text-gray-900">{selectedAppointment.appointmentTime || 'N/A'}</p>
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700">Ghi chú</label>
                      <p className="text-sm text-gray-900">{selectedAppointment.notes || 'Không có'}</p>
                    </div>
                  </>
                )}
              </div>
          ...
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Bạn có chắc chắn muốn xóa appointment #{appointmentToDelete.id}?
