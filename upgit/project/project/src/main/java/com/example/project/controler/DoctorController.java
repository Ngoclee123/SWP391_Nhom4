...
public class DoctorController {
    ...
    public ResponseEntity<?> uploadAvatar(@RequestParam("file") MultipartFile file) {
        try {
            ...
            // Đảm bảo đường dẫn tuyệt đối tới front-end/public/avatars
            String projectRoot = System.getProperty("user.dir");
            java.nio.file.Path uploadDir = java.nio.file.Paths.get(projectRoot, "uploads/avatars").normalize().toAbsolutePath();
