...
//         return null; // Ẩn biểu tượng chat nếu chưa đăng nhập
//     }

//     return (
//         <div className="fixed bottom-6 right-6 z-50">
//             <button
//                 className="bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 hover:scale-110 transform transition duration-300"
...
//             {isChatOpen && (
//                 <div className="w-80 sm:w-96 h-[500px] bg-white rounded-xl shadow-2xl flex flex-col absolute bottom-16 right-0 overflow-hidden">
...
//                         </div>
//                     )}
//                     <ul ref={messageAreaRef} className="flex-1 p-4 overflow-y-auto bg-gray-50">
//                         {messages.map((message, index) => (
//                             <li
//                                 key={index}
//                                 className={`flex items-center p-3 mb-2 rounded-lg ${
//                                     message.type === 'CHAT' ? 'bg-gray-200' : 'bg-blue-100'
//                                 }`}
//                             >
//                                 <span
//                                     className="w-8 h-8 rounded-full flex items-center justify-center mr-2 text-white font-bold"
//                                     style={{ backgroundColor: getAvatarColor(message.sender) }}
//                                 >
//                                     {message.sender[0]}
//                                 </span>
//                                 {message.type === 'JOIN' && (
//                                     <span>{message.sender} đã tham gia!</span>
//                                 )}
//                                 {message.type === 'LEAVE' && (
//                                     <span>{message.sender} đã rời!</span>
//                                 )}
//                                 {message.type === 'CHAT' && (
//                                     <>
