function WhyChooseUs() {
  return (
    <section id="why-us" className="py-16 bg-white">
      <div className="container mx-auto px-4" style={{marginRight: '30px'}}>
        <h2 className="text-3xl font-bold text-center text-blue-800 mb-8" style={{marginRight: '150px'}}>Vì sao chọn Baby Health Hub?</h2>
