...
const DoctorDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (location.pathname === '/doctor-dashboard/notifications') {
            console.log('Setting activeTab to notifications');
            setActiveTab('notifications');
        } else if (location.pathname === '/doctor-dashboard/send-notification') {
            console.log('Setting activeTab to send-notification');
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="flex-1 overflow-auto p-6">
                        ...
                        {activeTab === 'notifications' && (
                            <div>
                                {console.log('Rendering doctor NotificationsPage component')}
                                <NotificationsPage />
                            </div>
                        )}
                    </div>
